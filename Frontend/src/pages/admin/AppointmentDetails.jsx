...
export default function AdminAppointmentDetails() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <Link to="/admin/appointments" className="inline-flex items-center gap-1 text-sm text-primary-600 font-medium hover:underline">
      ...
      <div className="card p-6">
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-slate-500 mt-1">Full appointment information</p>
          </div>
